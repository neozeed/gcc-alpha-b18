     ...
     double *to;
{
  ...
  /* Actually, we do want to bias denorms (0 exponent before bias) because
     if we don't we'll convert it to a much larger number (effectively
     multiplying it by the bias!).  True zeros survive this as zero. */
