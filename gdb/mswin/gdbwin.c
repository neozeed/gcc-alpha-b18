...
// Override gdb's io routines to redirect stderr and stdio 
// to gdb's command window.
// List of io routines (this list is not complete):
//     perror
//     fflush
//     fputs_filtered
//     fputs_unfiltered
...
//     printfi_filtered
//     fprintf
// FIXME!!  Must make sure all io routines are redirected.
