...
static  void OnIdle();
  void doidle();
  void flush();	// flush pending buffer
  void add(const char *);
  // Overrides
...
// May want to implement someday
//  afx_msg void OnPrompt();
//  vv => void return; void args
#if 0
#define WM_PROMPT (WM_USER+1)
#define ON_WM_PROMPT() \
	{ WM_PROMPT, 0, 0, 0, AfxSig_vv, \
	    (AFX_PMSG)(AFX_PMSGW)(void (AFX_MSG_CALL CWnd::*)(void))OnPrompt},
#endif
