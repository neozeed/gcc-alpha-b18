...
#include "stdafx.h"
//#include "info.h"
#include "resource.h" /* Don't think this one is needed */
...
void CGnuInfoFrame::RecalcLayout(BOOL bNotify) 
{
  ...
  /* The framework calls OnSize before everything's 
   * been initialzed; we want to skip this section then */
  if (text_view.inited == 1)
    {
