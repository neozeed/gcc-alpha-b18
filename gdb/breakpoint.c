  ...
  if (arg == 0)
    {
      ...
      ALL_BREAKPOINTS_SAFE(b, temp)
	{
	  /* Negative (internal) breakpoints should never be deleted
	     unless explcitly named, breaks longjmp, etc. forever.
	     FIXME?: What about bpt 0? */
	  if (b->number < 0)
	      continue;
...
If an address is specified, break at the line containing that address.\n",
