...
/* Close all the BFD's file descriptors in objfiles... this is in preparation
   for an exec() where we don't want the fd's to be in the child.  We don't
   want to close the BFDs (in case we're in a vfork()), just the fds */
