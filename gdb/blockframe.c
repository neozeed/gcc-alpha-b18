...
/* This change should not be needed, FIXME!  We should
   ...
   there are machines (OpenNT, e.g.) that require interleaved extraction of 
   BOTH fp and pc, and which require sometime fairly complex operations to
   find the next pc.  It would make more sense to replace most of this section
   ...
   they are used in other places.  (IN_SIGTRAMP would not change,
   INIT_FRAME_PC would become a no-op, and FRAME_SAVED_PC would just
