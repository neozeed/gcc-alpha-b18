...
typedef struct lang_input_statement_struct
{
  ...
  /* Order in which this file (really, archive member) was found; sort
     sometimes needs to maintain that order */
  int encounter_position;
...
typedef struct
{
  ...
  size_t size;
  asection *output_section;
  struct bfd_link_order_stublist l;  /* must be last */
