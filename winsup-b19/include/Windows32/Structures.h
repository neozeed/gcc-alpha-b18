...
typedef struct _CONTEXT {
    ...
    double FltF30;
    double FltF31;
    double IntV0;    //  $0: return value register, v0
    double IntT0;    //  $1: temporary registers, t0 - t7
    double IntT1;    //  $2:
    double IntT2;    //  $3:
    double IntT3;    //  $4:
    double IntT4;    //  $5:
    ...
    double IntT6;    //  $7:
    double IntT7;    //  $8:
    double IntS0;    //  $9: nonvolatile registers, s0 - s5
    double IntS1;    // $10:
    double IntS2;    // $11:
    double IntS3;    // $12:
    double IntS4;    // $13:
    double IntS5;    // $14:
    double IntFp;    // $15: frame pointer register, fp/s6
    double IntA0;    // $16: argument registers, a0 - a5
    double IntA1;    // $17:
    double IntA2;    // $18:
    double IntA3;    // $19:
    double IntA4;    // $20:
    double IntA5;    // $21:
    double IntT8;    // $22: temporary registers, t8 - t11
    double IntT9;    // $23:
    double IntT10;   // $24:
    double IntT11;   // $25:
    unsigned long long int IntRa;    // $26: return address register, ra
    double IntT12;   // $27: temporary register, t12
    double IntAt;    // $28: assembler temp register, at
    double IntGp;    // $29: global pointer register, gp
    double IntSp;    // $30: stack pointer register, sp
    double IntZero;  // $31: zero register, zero
    double Fpcr;     // floating point control register
    double SoftFpcr; // software extension to FPCR
    unsigned long long int Fir;      // (fault instruction) continuation address
