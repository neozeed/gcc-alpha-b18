...
#endif /* ifndef __INSIDE_CYGWIN32__ */
...
extern "C" 
{
  ...
  PASCAL struct protoent  *  getprotobynumber(int number);
...
PASCAL struct hostent  *   gethostbyaddr(const char  * addr, int, int);
...
SOCKET PASCAL FAR rcmd (char **ahost, unsigned short inport, char *locuser,
			   char *remuser, char *cmd, SOCKET *fd2p);
SOCKET PASCAL FAR rresvport (int *port);
SOCKET PASCAL FAR rexec(char **host, unsigned short port, char *user,
