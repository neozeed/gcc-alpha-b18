...
void* 	memcpy (void* pCopyTo, const void* pSource, size_t sizeCopy);
void*	memmove (void* pMoveTo, const void* pSource, size_t sizeMove);
void*	memset (void* p, int cFill, size_t sizeFill);
