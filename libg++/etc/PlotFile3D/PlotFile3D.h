...
// we need some constants that are not defined in minimal headers, but
// will work with _XOPEN_SOURCE (at least reasonably portably.)
...
protected:
  ...
  void         line2D(int u0, int v0, int u1, int v1);
