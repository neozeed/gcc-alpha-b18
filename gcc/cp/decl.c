     ...
     int tag_transparent;
{
  ...
  GNU_xref_start_scope ((host_ptr_as_int) newlevel);
     ...
     int functionbody;
{
  ...
  GNU_xref_end_scope ((host_ptr_as_int) current_binding_level,
		      (host_ptr_as_int) current_binding_level->level_chain,
     ...
     int force;
{
  ...
  GNU_xref_end_scope ((host_ptr_as_int) class_binding_level,
		      (host_ptr_as_int) class_binding_level->level_chain,
