...
static char *lang_printable_name (tree decl, int verbosity);
...
/* Plug-in replacement for identifying the name of a decl and level of
   verbosity */

static char *
lang_printable_name (tree decl, int verbosity)
{
