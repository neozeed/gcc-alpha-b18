...
/* Abort routines */
extern void real_fatal_insn_not_found	PROTO((rtx,char *,int));
#define fatal_insn_not_found(a) real_fatal_insn_not_found(a,__FILE__,__LINE__)
extern void real_fatal_insn			PROTO((char *, rtx, int));
#define fatal_insn(a,b) real_fatal_insn(a,b,__LINE__)
