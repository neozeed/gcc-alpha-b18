...
s/@gxx_include_dir@/$(libdir)\/g++-include/
s/@SET_MAKE@/make=nmake/
s/@target_overrides@//
s/@host_overrides@//
s/@cross_defines@//
s/@cross_overrides@//
s/@build_overrides@//
s/@language_hooks@//
s/@language_fragments@//
s/stmp-headers/stmpheaders/
s/@DEFS@//
s/@extra_c_flags@/ -DNO_SYS_FILE_H /
s/@sched_prefix@//
s/@sched_cflags@//
s/@LN@/copy/
s/@extra_c_objs@//
s/touch/echo .>/
s/@maybe_use_collect2@//
s/@extra_objs@//
