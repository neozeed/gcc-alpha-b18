...
if %2.==alpha. echo #define TARGET_CPU_DEFAULT 64 +4 +8 >tm.h
...
echo all.nt: cpp.exe cc1.exe  xgcc.exe ld.exe stmp-headers libgcc.lib stmp-float_h specs stamp-objlist>> Makefile
...
echo static char *multilib_raw[] = { > multilib.h1
echo ". ;", >> multilib.h1
echo NULL >> multilib.h1
echo }; >> multilib.h1
echo static char *multilib_matches_raw[] = {  >> multilib.h1
echo NULL >> multilib.h1
echo }; >> multilib.h1
echo static char *multilib_extra = ""; >> multilib.h1
