...
#define CPP_PREDEFINES "-DWIN32 -D_WIN32 -DWINNT -DPOSIX  \
  -D__CYGWIN32__  -D__STDC__=1  \
  -D_M_ALPHA -D_ALPHA_ -D__alpha -D__alpha__ \
  -D__unaligned= -D__stdcall= -D__cdecl= \
...
#define TARGET_VERSION fprintf (stderr, " (alpha cygwin32)");
...
#undef LINK_SPEC
#define LINK_SPEC "-stack 0x400000,0x10000 %{mwindows:--subsystem windows} \
 %{!mwindows:--subsystem console} %{g}"
...
/* additions for to attribute section */
