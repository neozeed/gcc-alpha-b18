...
(define_attr "cpu"
  "default,r3000,r6000,r4000,r4100,r4300,r4600,r4650,r5000,r5900,r8000" ; CYGNUS LOCAL gavin/r5900
...
(define_function_unit "memory" 1 0
  (and (eq_attr "type" "load")
       (eq_attr "cpu" "!r3000,r4600,r4650,r4100,r4300,r5000,r5900")) ; CYGNUS LOCAL gavin/r5900
  3 0)
...
(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul")
       (eq_attr "cpu" "!r3000,r4000,r4600,r4650,r4100,r4300,r5000,r5900")) ; CYGNUS LOCAL gavin/r5900
  17 17)
...
(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul")
       (and (eq_attr "mode" "SI") (eq_attr "cpu" "r4300,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  5 5)
...
(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul")
       (and (eq_attr "mode" "DI") (eq_attr "cpu" "r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  9 9)
...
(define_function_unit "imuldiv" 1 0
  (and (eq_attr "type" "idiv")
       (and (eq_attr "mode" "SI") (eq_attr "cpu" "r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  36 36)
...
(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fcmp") (eq_attr "cpu" "!r3000,r6000,r4300,r5000,r5900")) ; CYGNUS LOCAL gavin/r5900
  3 0)
...
(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fcmp") (eq_attr "cpu" "r5000,r5900")) ; CYGNUS LOCAL gavin/r5900
  1 0)
...
(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fabs,fneg")
       (eq_attr "cpu" "!r3000,r4600,r4650,r4300,r5000,r5900")) ; CYGNUS LOCAL gavin/r5900
  2 0)

(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fabs,fneg") (eq_attr "cpu" "r3000,r4600,r4650,r5000,r5900")) ; CYGNUS LOCAL gavin/r5900
  1 0)

(define_function_unit "mult" 1 1
  (and (eq_attr "type" "fmul")
       (and (eq_attr "mode" "SF")
	    (eq_attr "cpu" "!r3000,r6000,r4600,r4650,r4300,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  7 0)

(define_function_unit "mult" 1 1
  (and (eq_attr "type" "fmul")
       (and (eq_attr "mode" "SF") (eq_attr "cpu" "r3000,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  4 0)
...
(define_function_unit "mult" 1 1
  (and (eq_attr "type" "fmul")
       (and (eq_attr "mode" "DF") (eq_attr "cpu" "!r3000,r6000,r4300,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  8 0)

(define_function_unit "mult" 1 1
  (and (eq_attr "type" "fmul")
       (and (eq_attr "mode" "DF") (eq_attr "cpu" "r3000,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  5 0)
...
(define_function_unit "divide" 1 1
  (and (eq_attr "type" "fdiv")
       (and (eq_attr "mode" "SF") (eq_attr "cpu" "r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  21 0)
...
(define_function_unit "divide" 1 1
  (and (eq_attr "type" "fsqrt")
       (and (eq_attr "mode" "SF") (eq_attr "cpu" "!r4600,r4650,r4300,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  54 0)
...
(define_function_unit "divide" 1 1
  (and (eq_attr "type" "fsqrt")
       (and (eq_attr "mode" "DF") (eq_attr "cpu" "!r4600,r4650,r4300,r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  112 0)
...
(define_function_unit "divide" 1 1
  (and (eq_attr "type" "fsqrt")
       (and (eq_attr "mode" "DF") (eq_attr "cpu" "r5000,r5900"))) ; CYGNUS LOCAL gavin/r5900
  36 0)
