...
#include <sys/types.h>
#include <sys/stat.h>
#if ! defined (_WIN32) || defined (__CYGWIN32__) || defined(__OPENNT)
...
static const char * default_syscalls_dir = STD_PROTO_DIR;
...
#ifndef UNPROTOIZE
    if ( (default_syscalls_dir = _prefixInstallPath(STD_PROTO_DIR, NULL, 0)) == (char *)NULL) {
	default_syscalls_dir = STD_PROTO_DIR;
    }
#endif
#endif
