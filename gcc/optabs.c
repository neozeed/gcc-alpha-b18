     ...
     int unsignedp;
{
  ...
  /* No hardware instruction available; call a library routine to convert from
      ...
      else
	{
      ...
      emit_libcall_block (insns, target, value,
			  gen_rtx (
			      unsignedp ? UNSIGNED_FLOAT : FLOAT, 
			      GET_MODE (to), from));
    }
...
#define INT_TYPE_SIZE BITS_PER_WORD
  ...
  floatunssisf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunssisf");
  floatunsdisf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunsdisf");
  floatunstisf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunstisf");

  floatunssidf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunssidf");
  floatunsdidf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunsdidf");
  floatunstidf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunstidf");

  floatunssixf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunssixf");
  floatunsdixf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunsdixf");
  floatunstixf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunstixf");

  floatunssitf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunssitf");
  floatunsditf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunsditf");
  floatunstitf_libfunc = gen_rtx (SYMBOL_REF, Pmode, "__floatunstitf");
