     ...
     bfd *abfd;
{
  ...
  for (i = 0, hdrpp = sections; i < count; i++, hdrpp++)
	       ...
	       < hdr->lma)
	{
      ...
      else if ((abfd->file_flags & D_PAGED) == 0)
	{
     ...
     bfd *abfd;
{
  ...
  if ((abfd->file_flags & (EXEC_P | DYNAMIC)) == 0)
    {
     ...
     bfd *abfd;
{
  ...
  else if ((abfd->file_flags & EXEC_P) != 0)
