...
#define binary_bfd_find_stubs bfd_generic_find_stubs
#define binary_bfd_emit_stubs bfd_generic_emit_stubs
...
#define binary_bfd_getImageBase ((bfd_vma (*) PARAMS ((bfd *))) bfd_0)
