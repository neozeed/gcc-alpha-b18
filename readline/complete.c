...
#if !defined __MSDOS__ && (defined __CYGWIN32__ || ! defined _WIN32 || defined(__OPENNT))
#include <pwd.h>
#endif /* __MSDOS__ */
...
username_completion_function (text, state)
     ...
     char *text;
{
#if defined (MINIMAL) || defined(__OPENNT)
  /* OpenNT isn't minimal, but it doesn't provide the non-POSIX entries
     used to search the password file below.   (Neither do some other
     systems.) */
  return (char *)NULL;
#else /* !MINIMAL */
