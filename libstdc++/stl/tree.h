...
struct __rb_tree_iterator : public __rb_tree_base_iterator
{
  ...
  __rb_tree_iterator& operator++() { increment(); return *this; }
  __rb_tree_iterator operator++(int) {
    __rb_tree_iterator tmp = *this;
    increment();
    return tmp;
  }
    
  __rb_tree_iterator& operator--() { decrement(); return *this; }
  __rb_tree_iterator operator--(int) {
    __rb_tree_iterator tmp = *this;
    decrement();
    return tmp;
...
struct __rb_tree_const_iterator : public __rb_tree_base_iterator
{
  ...
  __rb_tree_const_iterator& operator++() { increment(); return *this; }
  __rb_tree_const_iterator operator++(int) {
    __rb_tree_const_iterator tmp = *this;
    increment();
    return tmp;
  }
    
  __rb_tree_const_iterator& operator--() { decrement(); return *this; }
  __rb_tree_const_iterator operator--(int) {
    __rb_tree_const_iterator tmp = *this;
    decrement();
    return tmp;
