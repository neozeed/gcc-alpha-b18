...
{
  const unsigned long* const last = __stl_prime_list + __stl_num_primes;
  const unsigned long* pos = lower_bound(__stl_prime_list, last, n);
...
public:
 ...
 void insert_unique(const_iterator f, const_iterator l)
  ...
  void erase(const hashtable::iterator& it);
  void erase(hashtable::iterator first, hashtable::iterator last);

  void erase(const hashtable::const_iterator& it);
  void erase(hashtable::const_iterator first, hashtable::const_iterator last);
...
template <class V, class K, class HF, class Ex, class Eq, class A>
void hashtable<V, K, HF, Ex, Eq, A>::erase(const hashtable::iterator& it)
{
...
template <class V, class K, class HF, class Ex, class Eq, class A>
void hashtable<V, K, HF, Ex, Eq, A>::erase(hashtable::iterator first, 
...
template <class V, class K, class HF, class Ex, class Eq, class A>
inline void
hashtable<V, K, HF, Ex, Eq, A>::erase(hashtable::const_iterator first, 
                                      hashtable::const_iterator last)
{
...
template <class V, class K, class HF, class Ex, class Eq, class A>
inline void
hashtable<V, K, HF, Ex, Eq, A>::erase(const hashtable::const_iterator& it)
{
